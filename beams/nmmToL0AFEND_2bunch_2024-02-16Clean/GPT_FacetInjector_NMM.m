classdef GPT_FacetInjector_NMM < handle & physConsts & batchLSF
  ...
  properties
    ...
    %NMM: Beam specs
    nmacro=2e6; % # of macro-particles. 1e4 is rough scan, 1e5 is point of diminishing returns, per CE
    Q0=1e-9; % Initial bunch charge %NMM: Two bunch = [0.5e-9 1.6e-9]
    ...
    sigt=2.2e-12; % Laser pulse duration per bunch (FWHM in s) [2e-12 5.25e-12] % NMM 2023-09-07, was 3.84 ps %% NMM: Two bunch = [2.2e-12 2.2e-12]
    ...
    SimData
    StoreVec=true; % NMM: Whether or not to save GPT snapshots
